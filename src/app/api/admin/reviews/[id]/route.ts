...
export async function DELETE(
  ...
  console.log('[API] DELETE /api/admin/reviews/[id]: Initiated');
  ...
  try {
    ...
    // 4. Delete Review using Service Role Client
    const { error } = await supabaseAdmin
      .from('resource_ratings') // Assuming resource_ratings table stores reviews
      .delete()
      .eq('id', reviewId);
